                ...
                <Reveal variant="scaleIn" className="rounded-4xl bg-white p-8 sm:p-12 lg:p-16 dark:bg-muted">
                    <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
                        ...
                        <h2 className="mt-8 max-w-6xl text-3xl font-bold leading-snug tracking-tight text-black sm:mt-10 sm:text-4xl md:text-[2.75rem] dark:text-foreground">
                            A JSON workspace built for modern developers
                        </h2>

                        <p className="mt-6 max-w-6xl text-sm leading-relaxed text-black/75 sm:mt-8 sm:text-base dark:text-foreground/70">
                            BracketView is a freemium online workspace for anyone who
                            handles API responses, configuration files, and exported data.
                            Whether you are debugging a REST endpoint, reviewing a webhook
                            payload, or cleaning up a hand-edited config, you get
                            formatting, validation, tree exploration, and query tools in
                            a single tab.
                        </p>
